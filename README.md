...
## Installation
The latest release can be downloaded from the [releases page](https://github.com/maguic/WinAgent/releases).
...
See [open issues](https://github.com/maguic/WinAgent/issues)
...
## Usage
    ...
    go get -u github.com/maguic/WinAgent
    cd $env:GOPATH/src/github.com/maguic/WinAgent
    promu build -v .
    .\WinAgent.exe
...
### Enable only service collector and specify a custom query
    ...
    .\WinAgent.exe --collectors.enabled "service" --collector.service.services-where "Name='WinAgent'"

### Enable only process collector and specify a custom query

    .\WinAgent.exe --collectors.enabled "process" --collector.process.processes-where "Name LIKE 'firefox%'"
