...
import (
	...
	"github.com/maguic/WinAgent/collector"
...
const (
	...
	defaultCollectors            = "cpu,cs,logical_disk,net,os,system,textfile"
...
var (
	scrapeDurationDesc = prometheus.NewDesc(
		...
		"WinAgent: Duration of a collection.",
		[]string{"collector"},
		nil,
	)
	scrapeSuccessDesc = prometheus.NewDesc(
		prometheus.BuildFQName(collector.Namespace, "exporter", "collector_success"),
		"WinAgent: Whether the collector was successful.",
		[]string{"collector"},
		nil,
	)
...
func init() {
	prometheus.MustRegister(version.NewCollector("WinAgent"))
}

func initWbem() {
	// This initialization prevents a memory leak on WMF 5+. See
	// https://github.com/maguic/WinAgent/issues/77 and linked issues
	// for details.
...
func main() {
	...
	kingpin.Version(version.Print("WinAgent"))
